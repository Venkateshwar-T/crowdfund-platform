      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Sheet>
          <SheetTrigger asChild>
            <CustomButton variant="outline" className="rounded-full gap-2">
          ...
          <SheetContent className="w-full sm:max-w-md flex flex-col h-full">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <RadioGroup defaultValue="any" className="flex flex-col gap-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="time-any" className="font-medium">Any</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="newest" id="time-newest" />
                      <Label htmlFor="time-newest" className="font-medium">Newest First</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="oldest" id="time-oldest" />
                      <Label htmlFor="time-oldest" className="font-medium">Oldest First</Label>
                    </div>
                  </RadioGroup>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <RadioGroup defaultValue="all" className="flex flex-col gap-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="status-all" className="font-medium">All</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="active" id="status-active" />
                      <Label htmlFor="status-active" className="font-medium">Active</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="completed" id="status-completed" />
                      <Label htmlFor="status-completed" className="font-medium">Completed</Label>
                    </div>
                  </RadioGroup>
                </div>
            ...
            <div className="mt-auto pt-6 border-t flex gap-3">
              <CustomButton variant="outline" className="flex-1 rounded-full">
                Reset
              </CustomButton>
              <CustomButton className="flex-1 rounded-full">
                Apply Filters
              </CustomButton>
            </div>
          </SheetContent>
